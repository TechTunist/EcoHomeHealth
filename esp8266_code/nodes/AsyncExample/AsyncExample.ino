...
void OnDataRecv(uint8_t * mac_addr, uint8_t *incomingData, uint8_t len) { 
  ...
  board["pressure"] = incomingReadings.hum;
...
<head>
  ...
  <style>
    body {font-family: Arial; display: inline-block; text-align: center; margin: 0;}
    h1 {  font-size: 2rem;}
  ...
  <div class="content">
    <div class="cards">
      ...
      <div class="card pressure">
        <p class="card-title"><i class="fas fa-tint"></i> BOARD #1 - pressure</p><p><span class="reading"><span id="h1"></span> Pa;</span></p><p class="timestamp">Last Reading: <span id="rh1"></span></p>
      </div>
      <div class="card temperature">
...
if (!!window.EventSource) {
 ...
 source.addEventListener('new_readings', function(e) {
  ...
  document.getElementById("h"+obj.id).innerHTML = obj.pressure.toFixed(2);
